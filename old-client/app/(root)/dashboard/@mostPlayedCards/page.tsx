...
import { mostPlayedCardsHeaders } from '@/constants/site';
import { mostPlayedCardsData } from '@/types/definitions';
	...
	return (
		<>
			<Suspense key={query + currentPage} fallback={<InvoicesTableSkeleton />}>
				...
				<Table data={data} columns={mostPlayedCardsHeaders} currentPage={currentPage} />
			</Suspense>
