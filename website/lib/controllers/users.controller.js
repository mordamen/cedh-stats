...
import dbType from '../middleware/database/users.dbtype.middleware'; // User-related data access and operations
import tokenService from '../middleware/token.middleware'; // Token generation and validation
import userValidationService from '../middleware/validation_users.middleware'; // Validation of user data
import hashService from '../middleware/hash.middleware'; // Hashing and comparison of passwords
import handleError from '../middleware/errorHandler.middleware'; // Middleware for handling errors
import normalizeUser from '../models/mongoDB/helpers/normalize_user'; // Data normalization for user input
