...
export const decksByGlobalColorIdentity = async (): Promise<DeckData[]> => {
	// Call the function to get the result
	const results: DeckData[] = await decksByColorIdentity();
...
export const deckStatsHandler = async () => {
...
// Function to aggregate averages of card types per deck
export const averagesPerDeckHandler = () => {
	const results = Deck.aggregate([
		{
			$project: {
				card: {
...
// Function to aggregate averages of card types per color identity
export const averagesByColorIdentityHandler = () => {
	const results = Deck.aggregate([
		{
			$project: {
				card: {
