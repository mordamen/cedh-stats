...
export const updateUser = async ({ userId, username, name, image, path }: Params): Promise<void> => {
	connectToDB();
...
const changeBusinessStatusById = (id: any) => {
...
export { registerUser, getUserByEmail, getAllUsers, getUserById, changeBusinessStatusById, deleteUserById };
