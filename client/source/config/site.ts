...
export const siteConfig = {
	...
	DeckStatsHeaders: [
		{ key: 'deckName', label: 'Deck Name' },
		{ key: 'colorIdentity', label: 'Color Identity' },
		{ key: 'artifactCount', label: '# of Artifacts' },
		{ key: 'landCount', label: '# of Lands' },
		{ key: 'sorceryCount', label: '# of Sorceries' },
		{ key: 'instantCount', label: '# of Instants' },
		{ key: 'planeswalkerCount', label: '# of Planeswalkers' },
		{ key: 'creatureCount', label: '# of Creatures' },
		{ key: 'battleCount', label: '# of Battles' },
		{ key: 'averageManaValue', label: 'Avg Mana Value' },
		{ key: 'uniqueCardCount', label: '# of Unique Cards' },
		,
	],
	// DeckStatsHeaders: [
